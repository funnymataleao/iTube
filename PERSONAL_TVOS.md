# PersonalTube для Apple TV

Персональная tvOS-сборка на основе SmartTubeIOS. Лицензия и история upstream
сохранены; основной репозиторий проекта подключён как `upstream`.

## Установка через Xcode

1. Откройте `SmartTube.xcworkspace`.
2. Выберите схему **Smart Tube**.
...
После разрешения возможных конфликтов соберите и запустите схему **Smart Tube**
