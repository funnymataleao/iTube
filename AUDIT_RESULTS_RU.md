...
**Файл:** `SmartTubeApp/Smart Tube/GoogleService-Info.plist`
...
3. `SmartTubeApp/Smart Tube/GoogleService-Info.plist` - Отключена аналитика
...
### ✅ Firebase Analytics
```bash
grep -A1 "IS_ANALYTICS_ENABLED" "Smart Tube/GoogleService-Info.plist"
